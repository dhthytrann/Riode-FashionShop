...
const Categories = () => {
  ...
  productSuggestData.push(productData[0]);
  productSuggestData.push(productData[1]);
  productSuggestData.push(productData[2]);
  productSuggestData.push(productData[3]);
